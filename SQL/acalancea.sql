...
--creare de secvente pentru inserare automata a ID-ului
...
ALTER TABLE EMPLOYEES ADD CONSTRAINT FK_EMPLOYEES_EMPL_MANAGER  FOREIGN KEY (MANAGER_ID)
REFERENCES EMPLOYEES (EMPLOYEE_ID);

ALTER TABLE DEPARTMENTS ADD CONSTRAINT FK_location  FOREIGN KEY (LOCATION_ID)
REFERENCES LOCATIONS (LOCATION_ID);
--ALTER TABLE EMPLOYEES DROP CONSTRAINT FK_EMPLOYEES_JOBS;
...
--ex5
SELECT count(EMPLOYEE_ID) FROM EMPLOYEES emp where emp.JOB_ID='IT_PROG' ORDER BY emp.FIRST_NAME;
SELECT * FROM EMPLOYEES emp where emp.JOB_ID='IT_PROG' ORDER BY emp.FIRST_NAME;
--ex6
SELECT * FROM EMPLOYEES emp INNER JOIN DEPARTMENTS dep on emp.DEPARTMENT_ID=dep.DEPARTMENT_ID ORDER BY emp.FIRST_NAME;
--ex7
SELECT * FROM EMPLOYEES emp INNER JOIN DEPARTMENTS dep on emp.DEPARTMENT_ID=dep.DEPARTMENT_ID where dep.LOCATION_ID=1700 ORDER BY emp.FIRST_NAME;
--ex9
CREATE OR REPLACE VIEW view9 AS
SELECT emp.EMPLOYEE_ID,emp.FIRST_NAME,dep.DEPARTMENT_NAME FROM EMPLOYEES emp INNER JOIN DEPARTMENTS dep on emp.DEPARTMENT_ID=dep.DEPARTMENT_ID;
--ex10
...
--ex14
SELECT 'FIRST NAME '||UPPER(FIRST_NAME) FROM EMPLOYEES;
--ex15
SELECT COUNT(*) FROM EMPLOYEES;
--ex16
SELECT Count(*) FROM EMPLOYEES emp where emp.JOB_ID='IT_PROG' ORDER BY emp.FIRST_NAME;
--ex17
SELECT AVG(emp.SALARY) FROM EMPLOYEES emp where emp.DEPARTMENT_ID=50;
--ex18
SELECT MAX(emp.SALARY),MIN(emp.SALARY) FROM EMPLOYEES emp INNER JOIN DEPARTMENTS dep on emp.DEPARTMENT_ID=dep.DEPARTMENT_ID where dep.LOCATION_ID=1700;
commit;