...
public class Exercise1Test {
    ...
    private String[] expectedResultsForFirstTest = {"russia", "romania", "rwanda", "RUSSIA", "ROMANIA", "RWANDA"};
    private String[] expectedResultsForSecondTest = {"equatorial guinea", "mozambique", "iraq", "qatar"};
    private String expectedCapital = "Bandar Seri Begawan";
    private int expectedCorrectCountriesForFirstTest = 3;
    private int expectedCorrectCountriesForSecondTest = 4;
    ...
    public void testIteratingOverKeys() throws Exception {
        ...
        Assert.assertEquals("Test Iterating Over Keys", expectedCorrectCountriesForFirstTest,
                getCorrectCountries(testResults, expectedResultsForFirstTest));
    }
    ...
    private int getCorrectCountries(List<String> testResults, String[] expected){
